...
$TCA['tx_ttnewsrssimport_feeds'] = array (
	'ctrl' => array (
		'title' => 'LLL:EXT:ttnews_rss_import/locallang_db.xml:tx_ttnewsrssimport_feeds',
		'label' => 'title',
		'tstamp' => 'tstamp',
		'crdate' => 'crdate',
		'cruser_id' => 'cruser_id',
...
if (TYPO3_MODE == 'BE') {
	t3lib_extMgm::insertModuleFunction(
		...
		'LLL:EXT:ttnews_rss_import/locallang_db.xml:moduleFunction.tx_ttnewsrssimport_modfunc1',
		'wiz'
	);
}
